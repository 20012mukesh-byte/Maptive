  ...
  return (
    <div className="space-y-6 p-6">
      <div className="flex items-center gap-2 mb-6">
        ...
        <h1 className="text-2xl font-bold">Network Management System</h1>
      </div>
                    ...
                    {response.topology.connections.map((conn, idx) => (
                      <div key={idx} className="flex items-center justify-between p-2 border rounded">
                        <div className="flex items-center gap-2">
                          ...
                          <span>{conn.from_device} → {conn.to_device}</span>
                        </div>
                  ...
                  {response.alerts.map((alert, idx) => (
                    <div key={idx} className="flex items-center justify-between p-3 border rounded">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <p className="font-medium">{alert.device}: {alert.issue}</p>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div>
                ...
                <p className="text-gray-700">{response.analysis.summary}</p>
              </div>
              
              <div>
                <h4 className="font-semibold mb-2">Root Cause</h4>
                <p className="text-gray-700">{response.analysis.cause}</p>
              </div>
              
              <div>
                <h4 className="font-semibold mb-2">Recommendation</h4>
                <p className="text-gray-700">{response.analysis.suggestion}</p>
              </div>
